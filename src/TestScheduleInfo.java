...
public class TestScheduleInfo {
    ...
    public void recurrence_day() throws Exception {
        ...
        assertEquals(minutes_inDay, schedule_info.Recurrence_delay);
    }
    ...
    public void recurrence_hour() throws Exception {
        ...
        assertEquals(minutes_inHour, schedule_info.Recurrence_delay);
    }
    ...
    public void recurrence_min() throws Exception {
        ...
        assertEquals(3, schedule_info.Recurrence_delay);
    }
    ...
    public void Zer_duration() throws Exception {
        assertThrows(Exception.class,() -> {
            schedule_info = new Schedule_Info(LocalDateTime.parse("2021-05-26T10:00:00"), Duration.ofMinutes(0),
                    2, "emily");
        });
    }
}

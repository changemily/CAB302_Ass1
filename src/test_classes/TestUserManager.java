...
public class TestUserManager {
    ...
    /**
     * Test 2.1 - Create a new user, with Edit user_classes.User permissions for current user
     * @throws  Exception throws exception if invalid permission
     */
    @Test
    ...
    /**
     * Test 2.2 - Create a new user, without Edit user_classes.User permission for current user
     * @throws  Exception throws exception if invalid permission
     */
    @Test
